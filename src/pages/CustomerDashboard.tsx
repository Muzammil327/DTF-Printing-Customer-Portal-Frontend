        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          ...
          <Card className="card-modern shadow-modern slide-in-left">
            ...
            <CardContent>
              ...
              <div className="mt-6 pt-4 border-t border-slate-200">
                <Link to="/upload" className="text-sm text-blue-600 hover:text-blue-700 font-medium flex items-center group">
                  View all uploads
          ...
          <Card className="card-modern shadow-modern slide-in-right">
            ...
            <CardContent>
              ...
              <div className="mt-6 pt-4 border-t border-slate-200">
                <Link to="/orders" className="text-sm text-blue-600 hover:text-blue-700 font-medium flex items-center group">
                  View order history
                  <ArrowRight className="h-3 w-3 ml-1 group-hover:translate-x-1 transition-transform" />
                </Link>
              </div>
